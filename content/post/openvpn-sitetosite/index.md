...
tags: ["openvpn","vpn","terraform","azure","site-to-site",]
categories: ["VPN","Terraform","Cloud-Init"]
date: 2022-11-10
image: openvpn_sitetosite.png
---
...
2. Under User Management -> User Permissions, give the user Allow Auto-login rights.
    - ![User Permissions](openvpn_userlogin.png "User Permissions")
3. Under that user, hit More settings.
    ...
    - ![User Settings](openvpn_UserPermissiosnedit.png "User Settings")
...
1. Under the Configuration -> VPN Settings tab.
    ...
    - ![VPN Settings](openvpn_VPNSettings.png "VPN Settings")
...
2. Download thee client.vpn file from your VPN server
    ...
    - ![client.ovpn Download](openvpn_autologin.png "client.ovpn Download")
